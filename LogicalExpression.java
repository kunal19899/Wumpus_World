		...
		public void setUniqueSymbol( String newSymbol ) 
			...
			if( this.uniqueSymbol != null ) 
                  ...
                  else if( valid ) 
                  {
					...
					flag = CheckTrueFalse.symbols.containsKey(newSymbol);
                    if (!flag)
                    {
                        CheckTrueFalse.symbols.put(newSymbol,2);
                        CheckTrueFalse.hash[a++][0]=newSymbol;
                        CheckTrueFalse.hash[a-1][1]=Integer.toString(a-1);
                    }
			} 
		}
